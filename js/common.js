...
//remove symbols
    ...
    function initMap() {
        map = new google.maps.Map(
            ...
            {center: new google.maps.LatLng(50.452121, 30.519472), zoom: 5, maxZoom: 16,
                styles: [
        ...
        var features = [
            {
                position: new google.maps.LatLng(50.451977, 30.519481),
                type: 'kiev_sofievska'
            },
            {
                position: new google.maps.LatLng(50.507820, 30.498440),
                type: 'kiev2_dreamtown'
            },

            {
                position: new google.maps.LatLng(46.482879, 30.735774),
                type: 'odessa'
            },

            {
                position: new google.maps.LatLng(54.899251, 52.273905),
                type: 'almetyevsk'
            },
            ...
            {
                position: new google.maps.LatLng(47.908201, 33.396836),
                type: 'krivyiRog'
            }
        ];
